...
func (db *DB) GetLastCompletedRun() (*ConsolidationRun, error) {
	...
	run.RunAt, err = time.Parse("2006-01-02 15:04:05", runAt)
	if err != nil {
		// Also try with timezone suffix that SQLite might append
		run.RunAt, err = time.Parse("2006-01-02 15:04:05-07:00", runAt)
		if err != nil {
